...
public class Webhook {
    ...
    private static final String AMAZON_WEBHOOK_URL = System.getenv("AMAZON_WEBHOOK_URL");
    ...
    public static void sendAmazonMessage(String content) {
        try{
            JSONObject payload = new JSONObject();
            payload.put("content", "\n<=>\n" + content + "\n<=>\n");
            ...
            logger.error("Webhook: Unable to send amazon message!: {}", content);
        }
    }
}